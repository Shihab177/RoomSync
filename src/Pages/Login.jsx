      ...
      <div className=" md:max-w-md  p-2 mx-2 rounded-md border border-gray-300   sm:p-8 md:mx-auto mt-9 bg-[#F6F6F6] shadow-md dark:bg-gray-50 dark:text-gray-800">
        ...
        <div className="my-6 space-y-4">
          <button
            ...
            type="button"
            className="flex items-center justify-center w-full p-4 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1 dark:border-gray-600 text-white bg-[#38BDF8]"
          >
            <svg
        ...
        <form onSubmit={handelLogin} className="space-y-8">
          ...
          <button
            type="submit"
            className="w-full px-8 py-3 font-semibold rounded-md text-black bg-[#38BDF8]"
          >
            Login
          </button>
        </form>
