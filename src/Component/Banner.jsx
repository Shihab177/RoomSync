        ...
        <SwiperSlide className=''>
           <div className='flex items-center h-[450px] bg-[#EEF0EF] '>
            ...
            <span className="md:h-50 h-30 px-3 items-center">
               <h1 className='md:text-[37px] text-[13px] text-black  font-semibold'>Find the Perfect Roommate,</h1>
              
               <p className='mt-2 md:mt-4 md:text-[20px] text-black text-[9px]'> Connect with like-minded people and create a home full <br />
