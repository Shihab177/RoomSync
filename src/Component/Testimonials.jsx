...
const Testimonials = () => {
  return (
    <div className="md:container mx-auto my-10 md:my-20 px-4">
      <h1 className="md:text-[40px] text-[19px] font-bold text-center">Testimonials</h1>
      <p className="md:text-[30px] text-[14px] font-semibold text-center mb-10">
          ...
          <SwiperSlide key={index}>
            <div className="flex flex-col md:flex-row  bg-[#F9FAFB] justify-center gap-15 text-center md:text-left">
              ...
              <div className="text-center max-w-2xl">
                ...
                <p className="mt-4 mb-10 font-semibold text-black">
                  {item.name}
                </p>
              </div>
            </div>
